...
| ```aleph_rproxy```   | ```aleph_wfe```   |--|Enrutamiento de solicitudes web desde el proxy inverso hacia el web frontend.|
| ```aleph_dfe```   | ```aleph_ag_lb```   |-|Enrutamiento de peticiones desde el frontend desktop hacia el API Gateway|
