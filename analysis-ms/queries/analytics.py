...
def get_top_songs(limit: int = 10):
    try:
        ...
        logging.error(f"Error en get_top_songs: {e}")
        raise
...
def get_top_albums(limit: int = 10):
    try:
        ...
        logging.error(f"Error en get_top_albums: {e}")
        raise
...
def get_top_songs_by_country(country: str, limit: int = 10):
    try:
        ...
        logging.error(f"Error en get_top_songs_by_country: {e}")
        raise
...
def get_top_artists(limit: int = 10):
    try:
        ...
        logging.error(f"Error en get_top_artists: {e}")
        raise
...
def get_most_active_users(limit: int = 10):
    try:
        ...
        logging.error(f"Error en get_most_active_users: {e}")
        raise
